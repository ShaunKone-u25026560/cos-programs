...
CharacterColumn::CharacterColumn(std::string columnName, int columnSize) // Function 1
                : Column(columnName, columnSize)
{
    // Initialise The array member to have columnSize number "Null" elements
    array = new CharacterElement*[this->columnSize];
...
CharacterColumn::~CharacterColumn() // Function 2
{
    if (array)
    {
...
CharacterColumn* CharacterColumn::clone() const // Function 3
{
    CharacterColumn* clone = new CharacterColumn(columnName, columnSize);
...
CharacterColumn& CharacterColumn::operator+=(std::string data) // Function 4 / 9
{
    if (this->array) // If array exists, append
    {
        // Create a element using "data"
        CharacterElement* newElement = new CharacterElement(data);

        // Create a copy of the array with the added size
        int newColumnSize = this->columnSize + 1;
        CharacterElement** newArray = new CharacterElement*[newColumnSize];
    ...
    }else
    {
        ...
        this->array = new CharacterElement*[1];
        this->array[0] = new CharacterElement(data);
...
CharacterColumn& CharacterColumn::operator-=(std::string data) // Function 5 / 10
{
...
CharacterColumn& CharacterColumn::operator-=(int index) // Function 6 / 11
{
...
int CharacterColumn::operator()(std::string data) const // Function 7 / 12
{
...
CharacterColumn& CharacterColumn::operator()(std::string value, std::string newValue) // Function 8 / 13
{
    if (array)
    {
        ...
        if (index < columnSize)
        {
            ...
            delete this->array[index];
            this->array[index] = new CharacterElement(newValue);
        }
    }
...
const CharacterElement* CharacterColumn::operator[](int pos) const // Function 9/ 14
{
...
const CharacterElement* CharacterColumn::operator[](std::string value) const// Function 10 / 15
{
    // Iterate through array to find the passed in data
    if (array)
    {
...
bool CharacterColumn::operator!() const// Function 11 / 16
{
    bool isValid = false;
