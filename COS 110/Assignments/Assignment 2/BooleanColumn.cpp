...
BooleanColumn::BooleanColumn(std::string columnName, int columnSize) // Function 1
                : Column(columnName, columnSize)
{
    // Initialise The array member to have columnSize number "Null" elements
    array = new BooleanElement*[this->columnSize];
...
BooleanColumn::~BooleanColumn() // Function 2
{
    if (array)
    {
...
BooleanColumn* BooleanColumn::clone() const // Function 3
{
    BooleanColumn* clone = new BooleanColumn(columnName, columnSize);
...
BooleanColumn& BooleanColumn::operator+=(std::string data) // Function 4 / 9
{
    if (this->array) // If array exists, append
    {
        // Create a element using "data"
        BooleanElement* newElement = new BooleanElement(data);

        // Create a copy of the array with the added size
        int newColumnSize = this->columnSize + 1;
        BooleanElement** newArray = new BooleanElement*[newColumnSize];
    ...
    }else
    {
        ...
        this->array = new BooleanElement*[1];
        this->array[0] = new BooleanElement(data);
...
BooleanColumn& BooleanColumn::operator-=(std::string data) // Function 5 / 10
{
...
BooleanColumn& BooleanColumn::operator-=(int index) // Function 6 / 11
{
...
int BooleanColumn::operator()(std::string data) const // Function 7 / 12
{
...
BooleanColumn& BooleanColumn::operator()(std::string value, std::string newValue) // Function 8 / 13
{
    if (array)
    {
        ...
        if (index < columnSize)
        {
            ...
            delete this->array[index];
            this->array[index] = new BooleanElement(newValue);
        }
    }
...
const BooleanElement* BooleanColumn::operator[](int pos) const // Function 9/ 14
{
...
const BooleanElement* BooleanColumn::operator[](std::string value) const// Function 10 / 15
{
    // Iterate through array to find the passed in data
    if (array)
    {
...
bool BooleanColumn::operator!() const// Function 11 / 16
{
    bool isValid = false;
