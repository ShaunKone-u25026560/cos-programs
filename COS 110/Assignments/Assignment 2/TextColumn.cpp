...
TextColumn::TextColumn(std::string columnName, int columnSize) // Function 1
                : Column(columnName, columnSize)
{
    // Initialise The array member to have columnSize number "Null" elements
    array = new TextElement*[this->columnSize];
...
TextColumn::~TextColumn() // Function 2
{
    if (array)
    {
...
TextColumn* TextColumn::clone() const // Function 3
{
    TextColumn* clone = new TextColumn(columnName, columnSize);
...
TextColumn& TextColumn::operator+=(std::string data) // Function 4 / 9
{
    if (this->array) // If array exists, append
    {
        // Create a element using "data"
        TextElement* newElement = new TextElement(data);

        // Create a copy of the array with the added size
        int newColumnSize = this->columnSize + 1;
        TextElement** newArray = new TextElement*[newColumnSize];
    ...
    }else
    {
        ...
        this->array = new TextElement*[1];
        this->array[0] = new TextElement(data);
...
TextColumn& TextColumn::operator-=(std::string data) // Function 5 / 10
{
...
TextColumn& TextColumn::operator-=(int index) // Function 6 / 11
{
...
int TextColumn::operator()(std::string data) const // Function 7 / 12
{
...
TextColumn& TextColumn::operator()(std::string value, std::string newValue) // Function 8 / 13
{
    if (array)
    {
        ...
        if (index < columnSize)
        {
            ...
            delete this->array[index];
            this->array[index] = new TextElement(newValue);
        }
    }
...
const TextElement* TextColumn::operator[](int pos) const // Function 9/ 14
{
...
const TextElement* TextColumn::operator[](std::string value) const// Function 10 / 15
{
    // Iterate through array to find the passed in data
    if (array)
    {
...
bool TextColumn::operator!() const// Function 11 / 16
{
    bool isValid = false;
